...
class CompanyImplTest {
    ...
    @Test
    @DisplayName("add Employ Test is working")
    ...
    void updateEmployeeTest() {
        ...
        company.updateEmployee(updateEmployee).getSecondName();
        assertEquals("New2Name",company.updateEmployee(updateEmployee).getSecondName());
        //assertEquals("55000",company.updateEmployee((SalesManager)updateEmployee.);
    }
