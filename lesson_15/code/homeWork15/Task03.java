...
// освещая семейные кружки из двадцати и тридцати человек, на балах в канделябры вставлялись
// восковые и спермацетовые свечи, когда мебель ставили симметрично,
// когда наши отцы были еще молоды не одним отсутствием морщин и седых волос,
// а стрелялись за женщин и из другого угла комнаты бросались поднимать нечаянно и не нечаянно
// уроненные платочки, наши матери носили коротенькие талии и огромные рукава и решали семейные
// дела выниманием билетиков, когда прелестные дамы-камелии прятались от дневного света,
// – в наивные времена масонских лож, мартинистов, тугендбунда, во времена Милорадовичей,
// Давыдовых, Пушкиных, – в губернском городе К.
...
public class Task03 {
    public static void main(String[] args) {
        ...
        String replacedTolstoy = tolstoy.replace("–",""); //delete char "-"
        replacedTolstoy = replacedTolstoy.replace(",",""); //delete char ","

        System.out.println("Tolstoy without '-' and ',': " + replacedTolstoy);

        String[] wordsArray = replacedTolstoy.split("\\s+"); //split string
        int wordCount = wordsArray.length;
        System.out.println("Word count: " + wordCount);;

        replacedTolstoy = replacedTolstoy.replace(" ", ""); //delete space
        System.out.println(replacedTolstoy);

        int chars = replacedTolstoy.length();
