...
public class DeliveryAppl {
    public static void main(String[] args) {
        ...
        items[0] = new Pizza(1000_1L, "Peperony", 7.50, 32, false);
        items[1] = new Pizza(1000_3L, "Peperony", 10.50, 45, true);
        items[2] = new SushiSet(1000_2L, "Namayori", 15.90, 9, true);
        items[3] = new SushiSet(1000_6L, "YokoOno", 12.99, 9, false);
        items[4] = new Drink(1001_7L, "Coca_Cola", 1.25, 0.5, false);
        items[5] = new Drink(1001_4L, "Beer", 1.35, 0.5, true);
